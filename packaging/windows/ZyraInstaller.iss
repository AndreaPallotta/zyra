...
Name: "vscode"; Description: "Zyra Official VS Code Extension (zyra-vscode-2.4.0.vsix)"; Types: custom; Check: IsVSCodeExtensionNeeded
...
Source: "..\..\dist_packages\zyra-vscode-2.4.0.vsix"; DestDir: "{app}\extension"; Flags: ignoreversion; Components: vscode
...
[Run]
Filename: "code"; Parameters: "--install-extension ""{app}\extension\zyra-vscode-2.4.0.vsix"" --force"; StatusMsg: "Installing Zyra VS Code Extension..."; Components: vscode; Flags: runhidden; Check: IsVSCodeExtensionNeeded
